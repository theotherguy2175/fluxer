...
| feature_guild_soundboard | Allow the guild soundboard, in guild scope |
| feature_higher_video_quality | Access to higher video streaming quality, in user scope |
| feature_message_polls | Allow polls in messages, in guild scope |
...
| max_poll_answer_length | Maximum characters per poll answer, in guild scope |
| max_poll_answers | Maximum answers per poll, in guild scope |
| max_poll_duration_hours | Maximum poll duration in hours, in guild scope |
| max_poll_question_length | Maximum characters in a poll question, in guild scope |
...
| max_soundboard_plays_per_second | Maximum soundboard plays per member per second, in guild scope |
| max_soundboard_sound_duration_ms | Maximum soundboard sound duration in milliseconds, in guild scope |
| max_soundboard_sounds_per_guild | Maximum soundboard sounds per guild, in guild scope |

...
export const LIMIT_KEY_SCOPES: Record<LimitKey, LimitScope> = {
	...
	max_soundboard_plays_per_second: 'guild',
	max_poll_answers: 'guild',
	max_poll_question_length: 'guild',
	max_poll_answer_length: 'guild',
	max_poll_duration_hours: 'guild',
...
export const LIMIT_KEY_METADATA: Record<LimitKey, LimitKeyMetadata> = {
	...
	max_soundboard_plays_per_second: {
		key: 'max_soundboard_plays_per_second',
		label: 'Max Soundboard Plays Per Second',
		description:
			'How many soundboard sounds one member may trigger per second in a channel. Bursts above this are rejected until the second rolls over.',
		category: 'guilds',
		scope: 'guild',
		isToggle: false,
		unit: 'count',
	...
	max_poll_answers: {
		key: 'max_poll_answers',
		label: 'Max Poll Answers',
		description: 'Most answers a single poll may offer. Communities can set a lower limit.',
		category: 'messages',
		scope: 'guild',
		isToggle: false,
		unit: 'count',
	...
	max_poll_question_length: {
		key: 'max_poll_question_length',
		label: 'Max Poll Question Length',
		description: 'Longest poll question, in characters. Communities can set a lower limit.',
		category: 'messages',
		scope: 'guild',
		isToggle: false,
		unit: 'count',
	...
	max_poll_answer_length: {
		key: 'max_poll_answer_length',
		label: 'Max Poll Answer Length',
		description: 'Longest poll answer, in characters. Communities can set a lower limit.',
		category: 'messages',
		scope: 'guild',
		isToggle: false,
		unit: 'count',
	...
	max_poll_duration_hours: {
		key: 'max_poll_duration_hours',
		label: 'Max Poll Duration',
		description: 'Longest a poll may stay open, in hours. Communities can set a lower limit.',
		category: 'messages',
		scope: 'guild',
		isToggle: false,
		unit: 'count',
	...
	feature_message_polls: {
		key: 'feature_message_polls',
		label: 'Message Polls',
		description: 'Allow members to create polls in text channels',
		category: 'features',
		scope: 'guild',
		isToggle: true,
	},

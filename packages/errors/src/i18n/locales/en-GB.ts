...
const ERROR_I18N_EN_GB_MESSAGES = defineErrorI18nLocaleMessages({
	...
	"account.ip_authorization_required": "IP authorisation is required.",
	...
	"account.sensitive_content_filter_age_restricted": "This sensitive content filter isn't available for your age group.",
	...
	"account.trusted_domains_wildcard_conflict": "The wildcard (*) can't be combined with specific domains.",
	"account.unauthorized": "Unauthorised.",
	...
	"admin_and_system.guild_id_required_for_search_index": "Community ID is required for channel message and member search indexes.",
	"admin_and_system.instance_policy_transition_not_allowed": "This instance policy change is not allowed.",
	"admin_and_system.invalid_acls_format": "Invalid ACL format.",
	...
	"admin_and_system.invalid_timezone_identifier": "Invalid time zone identifier.",
	...
	"attachments_and_uploads.no_uploaded_parts_to_finalize": "No uploaded parts are available to finalise.",
	...
	"attachments_and_uploads.too_many_files": "Too many files. Maximum {maxFiles, plural, one {# file} other {# files}} allowed.",
	...
	"auth_and_oauth.failed_to_parse_sso_user_info": "We couldn't read the response from your SSO provider. Please try again.",
	...
	"auth_and_oauth.invalid_or_expired_authorization_ticket": "Invalid or expired authorisation ticket.",
	"auth_and_oauth.invalid_or_expired_authorization_token": "Invalid or expired authorisation token.",
	...
	"auth_and_oauth.invalid_sso_authorization_code": "Invalid SSO authorisation code.",
	"auth_and_oauth.invalid_sso_token": "Invalid SSO token.",
	"auth_and_oauth.invalid_token_admin_api_key": "Invalid admin API key.",
	"auth_and_oauth.missing_authorization": "Missing or invalid authorisation header.",
	...
	"auth_and_oauth.response_type_must_be_code_for_non_bot_scopes": "Response type must be \"code\" for scopes other than \"bot\".",
	...
	"auth_and_oauth.sso_unable_to_allocate_discriminator": "We couldn't allocate a discriminator for your SSO account. Please try again.",
	"auth_and_oauth.sudo_mode_required": "Sudo mode is required.",
	"auth_and_oauth.unknown_application": "Unknown application.",
	"auth_and_registration.password_is_too_common": "Your password is too common. Please choose a less predictable password.",
	...
	"bots.search_scope_unavailable": "Bots can only search within a single community or channel.",
	...
	"calls_and_voice.voice_message_duration_exceeds_limit": "Voice message duration can't exceed {maxDuration, plural, one {# second} other {# seconds}}.",
	...
	"channels_and_guilds.animated_guild_banner_requires_feature": "Animated community banner requires ANIMATED_BANNER feature.",
	...
	"channels_and_guilds.cannot_leave_guild_as_owner": "You can't leave a community as the owner. Transfer ownership or delete the community instead.",
	...
	"channels_and_guilds.guild_id_must_match_referenced_message": "Community ID must match the community containing the channel the referenced message was fetched from.",
	...
	"channels_and_guilds.max_group_dm_recipients_reached": "You've reached the maximum of {count, plural, one {# group DM recipient} other {# group DM recipients}}.",
	"channels_and_guilds.max_group_dms_reached": "You've reached the maximum of {count, plural, one {# group DM} other {# group DMs}}.",
	"channels_and_guilds.max_guild_channels_reached": "You've reached the maximum of {count, plural, one {# community channel} other {# community channels}}.",
	"channels_and_guilds.max_guild_members_reached": "You've reached the maximum of {count, plural, one {# community member} other {# community members}}.",
	"channels_and_guilds.max_guild_roles_reached": "You've reached the maximum of {count, plural, one {# community role} other {# community roles}}.",
	"channels_and_guilds.max_guilds_reached": "You've reached the maximum of {count, plural, one {# community} other {# communities}}.",
	...
	"channels_and_guilds.single_community_cannot_create_guilds": "This instance is a single community, so additional communities cannot be created.",
	...
	"channels_and_guilds.unclaimed_account_cannot_create_guilds": "You need to complete your account setup before you can create communities.",
	...
	"colors.color_value_too_high": "Colour value must not exceed 0xffffff.",
	"colors.color_value_too_low": "Colour value must be at least 0x000000.",
	"connections.already_exists": "A connection of this type with this identifier already exists.",
	"connections.bluesky_oauth_authorization_failed": "We couldn't resolve that Bluesky handle. Please check it and try again.",
	...
	"connections.verification_failed": "Connection verification failed. Make sure the verification token is correctly placed.",
	...
	"email.domain_cannot_receive_mail": "That email domain cannot receive mail. Use an address on a domain that accepts email.",
	...
	"embeds.embed_index_out_of_bounds": "Embed index {embedIndex} is out of bounds (message has {embedCount, plural, one {# embed} other {# embeds}}).",
	"embeds.embed_splash_requires_feature": "Embed splash requires INVITE_SPLASH feature.",
	"embeds.embeds_exceed_max_characters": "Embeds must not exceed {maxCharacters, plural, one {# character} other {# characters}} in total.",
	...
	"harvest.unknown": "Unknown data export.",
	...
	"invites_and_beta.max_beta_codes_reached": "You've reached the maximum of {count, plural, one {# beta code} other {# beta codes}}.",
	...
	"invites_and_packs.max_emojis_reached": "You've reached the maximum of {count, plural, one {# emoji} other {# emojis}}.",
	...
	"limits.content_exceeds_max_length": "Text must not exceed {maxLength, plural, one {# character} other {# characters}}.",
	"limits.integer_out_of_int64_range": "Integer value is out of the valid int64 range.",
	"limits.rows_required": "`rows` is required.",
	"limits.string_length_exact": "String must be exactly {length, plural, one {# character} other {# characters}}.",
	"limits.string_length_invalid": "String length must be between {min} and {max} characters.",
	"limits.synced_preferences_too_large": "Synced preferences exceed {max_bytes} bytes.",
	"limits.timeout_cannot_exceed_365_days": "Timeout can't be longer than {maxDays, plural, one {# day} other {# days}} from now.",
	"limits.value_must_be_integer_in_range": "The value for `{name}` must be an integer between {minValue} and {maxValue}.",
	"media_and_memes.favorite_meme_name_required": "Saved media name is required.",
	"media_and_memes.favorite_meme_not_found": "Saved media wasn't found.",
	"media_and_memes.max_favorite_meme_tags_exceeded": "You can only add up to {limit, plural, one {# tag} other {# tags}} per saved media item.",
	"media_and_memes.max_favorite_memes_reached": "You've reached the maximum of {count, plural, one {# saved media item} other {# saved media items}}.",
	"media_and_memes.media_already_in_favorites": "This media is already in your saved media.",
	"media_and_memes.media_metadata_error": "Media metadata error.",
	"media_and_memes.unknown_favorite_meme": "Unknown saved media.",
	"messages.cannot_delete_more_than_100": "You can't delete more than {max, plural, one {# message} other {# messages}} at once.",
	"messages.cannot_edit_others_message": "You can't edit another user's message.",
	"messages.cannot_preload_more_than_100_channels": "You can't preload more than {max, plural, one {# channel} other {# channels}} at once.",
	...
	"mfa_and_passkeys.totp_not_enabled": "Two-factor authentication using an authenticator app isn't enabled for this account.",
	...
	"mfa_and_passkeys.webauthn_credential_limit_reached": "You've reached the maximum of {count, plural, one {# WebAuthn credential} other {# WebAuthn credentials}}.",
	"misc.cannot_send_messages_in_non_text_channel": "You can't send messages in a non-text channel.",
	"misc.cannot_send_messages_in_this_guild_without_email_verification": "You need to verify your email to send messages in this community.",
	...
	"misc_limits.max_applications_reached": "You've reached the maximum of {limit, plural, one {# application} other {# applications}}.",
	"misc_limits.max_bookmarks_reached": "You've reached the maximum of {count, plural, one {# bookmark} other {# bookmarks}}.",
	"misc_limits.max_category_channels_reached": "You've reached the maximum of {count, plural, one {# category channel} other {# category channels}}.",
	...
	"moderation_and_reports.ncmec_attachment_must_be_image_or_video": "Only image or video attachments can be reported to NCMEC.",
	...
	"moderation_and_reports.unclaimed_account_cannot_submit_reports": "You need to complete your account setup before you can submit reports.",
	"moderation_and_reports.unknown_report": "Unknown report.",
	"moderation_and_reports.user_is_not_banned": "This user isn't banned.",
	"names_and_normalization.name_empty_after_normalization": "Name can't be empty after normalisation.",
	"permissions.global_ip_banned": "Your IP address {ipAddress} has been permanently blocked from the Fluxer API by platform administrators. If you believe this is a mistake, contact support@fluxer.app to appeal. Include this IP address in your appeal.",
	"permissions.global_ip_temporarily_banned": "Your IP address {ipAddress} has been temporarily blocked from the Fluxer API for 24 hours because of abusive or unusual access patterns. We usually do not provide appeals for temporary API bans. Change IP addresses or wait for the ban to expire, and review the Fluxer API access patterns coming from your client.",
	...
	"phone.country_not_supported": "We don't send verification texts to this country. Use a mobile number from another country, or email support@fluxer.app and a person will review your account.",
	"phone.inbound_verification_required": "This number is verified by texting us instead of us texting you. Start phone verification again to get the code and the number to text.",
	"phone.invalid_number": "Invalid phone number.",
	"phone.lookup_unavailable": "Our phone number check is down right now, so we stopped before sending your code. This is on us, not your number. Wait a few minutes and try the same number again.",
	...
	"phone.number_not_in_service": "Your carrier says this number isn't in service. Check the number and try again, or email support@fluxer.app if it's correct.",
	"phone.number_not_mobile": "This isn't a mobile number, so it can't receive our text. Use a mobile number, or email support@fluxer.app if you think that's wrong.",
	"phone.verification_code_invalid": "Invalid phone verification code.",
	"phone.verification_needs_review": "We couldn't verify this number automatically. Email support@fluxer.app and a person will review your account.",
	...
	"premium_and_plans.custom_emojis_outside_source_require_premium": "You can't use custom emojis outside their source communities without Premium.",
	"premium_and_plans.custom_stickers_in_dms_require_premium": "You can't use custom stickers in DMs without Premium.",
	"premium_and_plans.custom_stickers_outside_source_require_premium": "You can't use custom stickers outside their source communities without Premium.",
	...
	"rate_limits.accent_color_changed_too_often": "You've changed your accent colour too often recently. Please try again in {minutes, plural, one {# minute} other {# minutes}}.",
	"rate_limits.avatar_changed_too_often": "You've changed your avatar too often recently. Please try again in {minutes, plural, one {# minute} other {# minutes}}.",
	"rate_limits.banner_changed_too_often": "You've changed your banner too often recently. Please try again in {minutes, plural, one {# minute} other {# minutes}}.",
	"rate_limits.bio_changed_too_often": "You've changed your bio too often recently. Please try again in {minutes, plural, one {# minute} other {# minutes}}.",
	"rate_limits.ip_authorization_resend_cooldown": "IP authorisation resend is on cooldown.",
	"rate_limits.ip_authorization_resend_limit_exceeded": "IP authorisation resend limit exceeded.",
	"rate_limits.phone_rate_limit_exceeded": "Phone rate limit exceeded.",
	"rate_limits.pronouns_changed_too_often": "You've changed your pronouns too often recently. Please try again in {minutes, plural, one {# minute} other {# minutes}}.",
	"rate_limits.rate_limited": "You're being rate limited.",
	"rate_limits.slowmode_rate_limited": "Slowmode rate limited.",
	"rate_limits.username_changed_too_often": "You've changed your username too often recently. Please try again in {minutes, plural, one {# minute} other {# minutes}}.",
	"rate_limits.voice_activity_sharing_on_cooldown": "You can only update your voice activity sharing default once every 24 hours. Please try again in {retry_after, plural, one {# second} other {# seconds}}.",
	...
	"stickers_and_emojis.max_reactions_reached": "You've reached the maximum of {count, plural, one {# reaction} other {# reactions}}.",
	"stickers_and_emojis.max_stickers_reached": "You've reached the maximum of {count, plural, one {# sticker} other {# stickers}}.",
	...
	"stripe.refund_cooldown_active": "You can request a self-serve refund once every 30 days. Please try again later.",
	...
	"tos_and_age.must_be_minimum_age": "You must be at least {minAge, plural, one {# year} other {# years}} old to create an account.",
	...
	"unknown_entities.unknown_user_flag": "The specified user flag isn't recognised.",
	...
	"usernames_and_tags.unclaimed_accounts_can_only_set_email_via_token": "Unclaimed accounts can only set an email address using a token.",
